"""
Static index constituent lists.
Updated: 2026-05. Refresh periodically as indices rebalance.
"""
...
SP500 = [
    ...
    "MO", "MOS", "MPC", "MPWR", "MRK", "MRNA", "MS", "MSCI", "MSFT", "MSI",
    ...
    "TJX", "TKO", "TMO", "TMUS", "TPR", "TRGP", "TRMB", "TROW", "TRV", "TSCO",
    "TSLA", "TSN", "TT", "TTD", "TTWO", "TXN", "TXT", "TYL", "UAL", "UBER",
    "UDR", "UHS", "ULTA", "UNH", "UNP", "UPS", "URI", "USB", "V", "VEEV",
    "VICI", "VLO", "VLTO", "VMC", "VRSK", "VRSN", "VRT", "VRTX", "VST", "VTR",
    "VTRS", "VZ", "WAB", "WAT", "WBD", "WDAY", "WDC", "WEC", "WELL", "WFC",
...
NASDAQ100 = [
    ...
    "COST", "CPRT", "CRWD", "CSCO", "CSGP", "CTSH", "DASH", "DDOG", "DLTR",
